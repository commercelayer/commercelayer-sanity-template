...
export { instantSearchContext, InstantSearchConsumer, InstantSearchProvider } from './core/context'; // Utils

export { HIGHLIGHT_TAGS } from './core/highlight';
export { default as version } from './core/version';
export { default as translatable } from './core/translatable'; // Widgets
...
export { default as connectVoiceSearch } from './connectors/connectVoiceSearch'; // Types
