...
function createInstantSearchManager(_ref) {
  ...
  var helper = (0, _algoliasearchHelper.default)(searchClient, indexName, (0, _objectSpread8.default)({}, _highlight.HIGHLIGHT_TAGS));
  ...
  function getSearchParameters() {
    ...
    .sort(sortIndexWidgetsFirst).reduce(function (indices, widget) {
      ...
      return (0, _objectSpread8.default)({}, indices, (0, _defineProperty2.default)({}, indexId, widgets.concat(widget)));
    }, {});
  ...
  function handleSearchSuccess(_ref3) {
    ...
    return function (event) {
      ...
      if (!isDerivedHelpersEmpty) {
        results = (0, _objectSpread8.default)({}, results, (0, _defineProperty2.default)({}, indexId, event.results));
      } else {
      ...
      store.setState((0, _objectSpread8.default)({}, partialState, {
        results: results,
    ...
    if (client.transporter && !client._cacheHydrated) {
      ...
      client.search = function (requests) {
        ...
        var requestsWithSerializedParams = requests.map(function (request) {
          return (0, _objectSpread8.default)({}, request, {
  ...
  function hydrateSearchClientWithMultiIndexRequest(client, results) {
    ...
    client.cache = (0, _objectSpread8.default)({}, client.cache, (0, _defineProperty2.default)({}, key, JSON.stringify({
      results: results.reduce(function (acc, result) {
        return acc.concat(result.rawResults);
      }, [])
    })));
  ...
  function onWidgetsUpdate() {
    ...
    store.setState((0, _objectSpread8.default)({}, store.getState(), {
      metadata: metadata,
      searching: true
  ...
  function onSearchForFacetValues(_ref5) {
    ...
    helper.searchForFacetValues(facetName, query, maxFacetHitsWithinRange).then(function (content) {
      ...
      store.setState((0, _objectSpread8.default)({}, store.getState(), {
        error: null,
        searchingForFacetValues: false,
        resultsFacetValues: (0, _objectSpread8.default)({}, store.getState().resultsFacetValues, (_objectSpread7 = {}, (0, _defineProperty2.default)(_objectSpread7, facetName, content.facetHits), (0, _defineProperty2.default)(_objectSpread7, "query", query), _objectSpread7))
      }));
    }, function (error) {
      store.setState((0, _objectSpread8.default)({}, store.getState(), {
        searchingForFacetValues: false,
