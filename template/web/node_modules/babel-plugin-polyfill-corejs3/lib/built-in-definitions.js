...
const StaticProperties = {
  ...
  Math: {
    ...
    log10: define("math/log10", ["es.math.log1p"]),
    log1p: define("math/log1p", ["es.math.log10"]),
  ...
  Number: {
    ...
    MAX_SAFE_INTEGER: define("number/max-safe-integer", ["es.number.min-safe-integer"]),
    MIN_SAFE_INTEGER: define("number/min-safe-integer", ["es.number.max-safe-integer"]),
