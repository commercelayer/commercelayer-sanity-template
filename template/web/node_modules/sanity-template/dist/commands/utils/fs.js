...
function isDirectory(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lstat(filePath)];
                case 1:
                    stats = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    filesInfo = _a.sent();
                    return [2 /*return*/, filesInfo.reduce(function (acc, arr) { return acc.concat(arr); }, [])];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    buf = _a.sent();
                    return [2 /*return*/, JSON.parse(buf.toString('utf-8'))];
            }
        });
    });
}
