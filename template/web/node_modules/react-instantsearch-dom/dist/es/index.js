...
export { translatable } from 'react-instantsearch-core'; // Widget
...
export { InstantSearch } from 'react-instantsearch-core'; // Connectors
...
export { connectToggleRefinement } from 'react-instantsearch-core'; // DOM
...
export { default as EXPERIMENTAL_Answers } from './widgets/Answers'; // hooks

export { default as EXPERIMENTAL_useAnswers } from './hooks/useAnswers'; // Utils

export { createClassNames } from './core/utils'; // voiceSearchHelper

export { default as createVoiceSearchHelper } from './lib/voiceSearchHelper'; // insights

export { default as getInsightsAnonymousUserToken } from './core/getInsightsAnonymousUserToken'; // InfiniteHits Cache
