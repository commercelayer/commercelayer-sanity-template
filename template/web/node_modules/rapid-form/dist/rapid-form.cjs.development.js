...
var useValidation = function useValidation(dispatch) {
  return react.useCallback(function (ref) {
    if (ref) {
      var _data;
...
var useRapidForm = function useRapidForm() {
  var _useReducer = react.useReducer(fetchReducer, {
    data: {},
    errors: {},
    refs: {}
  }),
...
exports.default = useRapidForm;
//# sourceMappingURL=rapid-form.cjs.development.js.map
