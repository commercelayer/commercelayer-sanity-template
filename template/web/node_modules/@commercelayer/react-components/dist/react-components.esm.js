import React, { createContext, Children, isValidElement, useContext, useState, useEffect, Fragment, useReducer, useRef } from 'react';
import PropTypes from 'prop-types';
import CLayer, { Order, SkuList as SkuList$1, CustomerAddress, Address as Address$1, Sku, ShippingMethod as ShippingMethod$1, Shipment as Shipment$1 } from '@commercelayer/js-sdk';
...
var Parent = function Parent(props) {
  ...
  return Child ? /*#__PURE__*/React.createElement(Child, props) : null;
};
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return CLayer.Order.withCredentials(config).create(_extends({
              metadata: metadata
            }, orderAttributes));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return Order.withCredentials(config).includes('billingAddress', 'shippingAddress').find(id);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (skuId) {
              attrs['item'] = CLayer.Sku.build({
                id: skuId
              });
            }

            _context4.next = 12;
            return CLayer.LineItem.withCredentials(config).create(attrs);
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        skuOption = CLayer.SkuOption.build({
                          id: skuOptionId
                        });
                        _context3.next = 4;
                        return CLayer.LineItemOption.withCredentials(config).create({
                          quantity: 1,
                          options: options,
...
var OrderContext = /*#__PURE__*/createContext(orderInitialState);
...
var ItemContext = /*#__PURE__*/createContext(initialItemContext);
                ...
                return runtime_1.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return SkuList$1.withCredentials(config).includes('skus').select({
                          skus: ['code']
                        }).find(id);
...
var SkuListsContext = /*#__PURE__*/createContext(skuListsInitialState);
...
var ExternalFunctionContext = /*#__PURE__*/createContext({
  url: null,
...
var AddToCartButton = function AddToCartButton(props) {
  ...
  var _useContext2 = useContext(ExternalFunctionContext),
      url = _useContext2.url,
      callExternalFunction = _useContext2.callExternalFunction;

  var _useContext3 = useContext(ItemContext),
  ...
  var _useContext4 = useContext(SkuListsContext),
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("button", _extends({
...
var AddressChildrenContext = /*#__PURE__*/createContext(initial);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return CustomerAddress.withCredentials(config).includes('address').all();
...
var CustomerContext = /*#__PURE__*/createContext(defaultCustomerContext);
...
var BillingAddressContext = /*#__PURE__*/createContext(defaultBillingAddressContext);

var defaultShippingAddressContext = {};
var ShippingAddressContext = /*#__PURE__*/createContext(defaultShippingAddressContext);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 12;
            return Address$1.withCredentials(config).create(billingAddress);
          ...
          case 13:
            ...
            delete orderAttributes._shippingAddressCloneId;
            _context.next = 20;
            return Address$1.withCredentials(config).create(shippingAddress);
          ...
          case 21:
            ...
            _context.next = 24;
            return Order.withCredentials(config).find(order.id);
...
var AddressesContext = /*#__PURE__*/createContext(defaultAddressContext);
...
var Address = function Address(props) {
  ...
  var _useContext5 = useContext(OrderContext),
  ...
  var components = items.map(function (address, k) {
    ...
    return /*#__PURE__*/React.createElement(AddressChildrenContext.Provider, {
      key: k,
      value: addressProps
...
var BaseSelect = function BaseSelect(props, ref) {
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("select", _extends({
    ref: ref,
    defaultValue: value
  }, p), Options);
};

var BaseSelect$1 = /*#__PURE__*/React.forwardRef(BaseSelect);
...
var BillingAddressFormContext = /*#__PURE__*/createContext({});
...
var AddressCountrySelector = function AddressCountrySelector(props) {
  var _props$required = props.required,
      ...
      value = props.value,
      name = props.name;
  var billingAddress = useContext(BillingAddressFormContext);
  var shippingAddress = useContext(ShippingAddressFormContext);
  useEffect(function () {
  ...
  return /*#__PURE__*/React.createElement(BaseSelect$1, _extends({
...
var AddressField = function AddressField(props) {
  ...
  var _useContext = useContext(AddressChildrenContext),
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("p", props, text);
};
...
var BaseInput = function BaseInput(props, ref) {
  ...
  var input = props.type === 'textarea' ? /*#__PURE__*/React.createElement("textarea", _extends({
    ref: ref
  }, p)) : /*#__PURE__*/React.createElement("input", _extends({
    ref: ref
  }, p));
  return children ? /*#__PURE__*/React.createElement(Parent, p, children) : input;
};

var BaseInput$1 = /*#__PURE__*/React.forwardRef(BaseInput);
...
var AddressInput = function AddressInput(props) {
  ...
  return /*#__PURE__*/React.createElement(BaseInput$1, _extends({
    ref: (billingAddress == null ? void 0 : billingAddress.validation) || (shippingAddress == null ? void 0 : shippingAddress.validation),
...
var CommerceLayerContext = /*#__PURE__*/createContext(initial$1);
...
var AddressesContainer = function AddressesContainer(props) {
  ...
  var _useReducer = useReducer(addressReducer, addressInitialState),
      state = _useReducer[0],
  ...
  var config = useContext(CommerceLayerContext);
  useEffect(function () {
    dispatch({
  ...
  return /*#__PURE__*/React.createElement(AddressesContext.Provider, {
    value: contextValue
  }, children);
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Sku.withCredentials(config).select('id').where({
              codeIn: skuCode
            }).first();
          ...
          case 3:
            sku = _context.sent;
            _context.next = 6;
            return Sku.withCredentials(config).select('inventory').find(sku.id);
...
var AvailabilityContext = /*#__PURE__*/createContext(availabilityInitialState);
...
var AvailabilityContainer = function AvailabilityContainer(props) {
  ...
  var _useReducer = useReducer(availabilityReducer, availabilityInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(AvailabilityContext.Provider, {
...
var AvailabilityTemplate = function AvailabilityTemplate(props) {
  ...
  var _useContext = useContext(AvailabilityContext),
      min = _useContext.min,
      max = _useContext.max,
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("p", p, text.join(' '));
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return Address$1.withCredentials(options.config).find(id);
...
var BillingAddressContainer = function BillingAddressContainer(props) {
  ...
  var _useReducer = useReducer(billingAddressReducer, billingAddressInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  var _useContext2 = useContext(AddressesContext),
  ...
  return /*#__PURE__*/React.createElement(BillingAddressContext.Provider, {
    value: contextValue
  }, children);
};
...
var BillingAddressForm = function BillingAddressForm(props) {
  ...
  var _useContext = useContext(AddressesContext),
  ...
  return /*#__PURE__*/React.createElement(BillingAddressFormContext.Provider, {
    value: {
...
var CheckoutLink = function CheckoutLink(props) {
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("a", _extends({
...
var CommerceLayer = function CommerceLayer(props) {
  ...
  return /*#__PURE__*/React.createElement(CommerceLayerContext.Provider, {
    value: _extends({}, p, {
      cache: cache
    })
  }, children);
...
var CustomerContainer = function CustomerContainer(props) {
  ...
  var _useReducer = useReducer(customerReducer, customerInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(CustomerContext.Provider, {
    value: contextValue
  }, children);
};
...
var BaseOrderPrice = function BaseOrderPrice(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("span", p, price);
};
...
var DiscountAmount = function DiscountAmount(props) {
  return /*#__PURE__*/React.createElement(BaseOrderPrice, _extends({
    base: "amount",
    type: "discount"
  }, props));
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return CLayer.GiftCardRecipient.withCredentials(config).create(values);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            recipientValues = {};
            _context2.next = 8;
            return CLayer.GiftCard.withCredentials(config).create(giftCardValue);
          ...
          case 28:
            ...
            item = CLayer.GiftCard.build({
              id: giftCard.id
            });
            _context2.next = 34;
            return CLayer.LineItem.withCredentials(config).create({
              quantity: 1,
              order: order,
              item: item
            });
...
var GiftCardContext = /*#__PURE__*/createContext(giftCardInitialState);
  ...
  return allErrors.map(function (v, k) {
    ...
    if (field) {
      if (v.resource === 'lineItem') {
        return lineItem && v.id === lineItem['id'] && /*#__PURE__*/React.createElement("span", _extends({
          key: k
...
var LineItemContext = /*#__PURE__*/createContext(initial$2);

var initial$3 = {
  lineItem: {}
};
var LineItemChildrenContext = /*#__PURE__*/createContext(initial$3);
...
var Errors = function Errors(props) {
  ...
  var _useContext2 = useContext(GiftCardContext),
      giftCardErrors = _useContext2.errors;

  var _useContext3 = useContext(LineItemContext),
      lineItemErrors = _useContext3.errors;

  var _useContext4 = useContext(AddressesContext),
      addressErrors = _useContext4.errors;

  var _useContext5 = useContext(CustomerContext),
      customerErrors = _useContext5.errors;

  var _useContext6 = useContext(LineItemChildrenContext),
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement(Fragment, null, msgErrors);
};
...
var ExternalFunction = function ExternalFunction(_ref) {
  var children = _ref.children,
      url = _ref.url;
  return /*#__PURE__*/React.createElement(ExternalFunctionContext.Provider, {
    value: {
      url: url,
      callExternalFunction: callExternalFunction
    }
...
var GiftCard = function GiftCard(props) {
  ...
  var _useContext = useContext(GiftCardContext),
...
var GiftCardContainer = function GiftCardContainer(props) {
  ...
  var _useReducer = useReducer(giftCardReducer, giftCardInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(GiftCardContext.Provider, {
    value: giftCardValue
  }, children);
};
...
var ItemContainer = function ItemContainer(props) {
  ...
  var _useReducer = useReducer(itemReducer, itemInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
...
var ShipmentChildrenContext = /*#__PURE__*/createContext(initial$4);
...
var LineItem = function LineItem(props) {
  ...
  var _useContext = useContext(LineItemContext),
      lineItems = _useContext.lineItems;

  var _useContext2 = useContext(ShipmentChildrenContext),
  ...
  var components = items && items.filter(function (l) {
    ...
    return /*#__PURE__*/React.createElement(LineItemChildrenContext.Provider, {
      key: k,
      value: lineProps
    }, children);
  });
...
var LineItemAmount = function LineItemAmount(props) {
  ...
  var _useContext = useContext(LineItemChildrenContext),
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("span", p, price);
};
...
var LineItemImage = function LineItemImage(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parenProps, props.children) : /*#__PURE__*/React.createElement("img", _extends({
    src: src
  }, props));
};
...
var LineItemName = function LineItemName(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("p", props, labelName);
};
...
var LineItemOptionChildrenContext = /*#__PURE__*/createContext(initial$5);
...
var LineItemOption = function LineItemOption(props) {
  ...
  var _useContext = useContext(LineItemOptionChildrenContext),
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : _.has(lineItemOption, "options." + name) ? /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("span", _extends({
    id: keyId,
    style: keyStyle,
    className: keyClassName
  }, p), name + ":"), /*#__PURE__*/React.createElement("span", _extends({
    id: id,
    style: style,
...
var LineItemOptions = function LineItemOptions(props) {
  ...
  var options = lineItemOptions.filter(function (o) {
    ...
    var showTitle = showName ? /*#__PURE__*/React.createElement("span", p, title || o.name) : null;
    var valueProps = {
      lineItemOption: o
    };
    return /*#__PURE__*/React.createElement(Fragment, {
      key: k
    }, showTitle, /*#__PURE__*/React.createElement(LineItemOptionChildrenContext.Provider, {
      value: valueProps
    }, children));
  });
  return /*#__PURE__*/React.createElement(Fragment, null, options);
};
...
var LineItemQuantity = function LineItemQuantity(props) {
  ...
  var _useContext2 = useContext(LineItemContext),
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : readonly ? /*#__PURE__*/React.createElement("span", p, quantity) : /*#__PURE__*/React.createElement("select", _extends({
    value: quantity,
...
var LineItemRemoveLink = function LineItemRemoveLink(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("a", _extends({}, props, {
    href: "#",
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return CLayer.LineItem.withCredentials(config).find(lineItemId);
...
var LineItemsContainer = function LineItemsContainer(props) {
  ...
  var _useReducer = useReducer(lineItemReducer, lineItemInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(LineItemContext.Provider, {
    value: lineItemValue
...
var LineItemsCount = function LineItemsCount(props) {
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("span", p, quantity);
};
...
var OrderStorageContext = /*#__PURE__*/createContext(initial$6);
...
var OrderContainer = function OrderContainer(props) {
  ...
  var _useReducer = useReducer(orderReducer, orderInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];

  var config = useContext(CommerceLayerContext);

  var _useContext = useContext(OrderStorageContext),
...
var OrderStorage = function OrderStorage(props) {
  ...
  return /*#__PURE__*/React.createElement(OrderStorageContext.Provider, {
    value: _extends({}, p, {
      setLocalOrder: setLocalOrder,
      getLocalOrder: getLocalOrder,
      deleteLocalOrder: deleteLocalOrder,
...
var PriceTemplate = function PriceTemplate(props) {
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("span", {
    className: props.className
  }, props.formattedAmount), props.showCompare && /*#__PURE__*/React.createElement("span", {
...
var getPricesComponent = function getPricesComponent(skuPrices, props) {
  if (_.isEmpty(skuPrices)) {
    return /*#__PURE__*/React.createElement(PriceTemplate, props);
  }
  ...
  return skuPrices.map(function (p, k) {
    ...
    return /*#__PURE__*/React.createElement(PriceTemplate, _extends({
      key: k
    }, props, {
...
var getSkusPrice = function getSkusPrice(skuCodes, _ref) {
  ...
  var allPrices = {};
  CLayer.Price.withCredentials(config).where(_extends({
...
var PricesContext = /*#__PURE__*/createContext(priceInitialState);
...
var Price = function Price(props) {
  ...
  var _useContext = useContext(PricesContext),
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement(Fragment, null, loading || _.isEmpty(pricesComponent) ? loader : pricesComponent);
};
...
var PricesContainer = function PricesContainer(props) {
  ...
  var _useReducer = useReducer(priceReducer, priceInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
...
var QuantitySelector = function QuantitySelector(props) {
  ...
  var _useContext2 = useContext(SkuListsContext),
  ...
  var _useState2 = useState(!!p.disabled),
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement("input", _extends({
    type: "number",
    max: maxInv,
    min: min,
    value: value || '',
...
var ShippingAddressContainer = function ShippingAddressContainer(props) {
  ...
  var _useReducer = useReducer(shippingAddressReducer, shippingAddressInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(ShippingAddressContext.Provider, {
    value: contextValue
  }, children);
};
...
var ShippingAddressForm = function ShippingAddressForm(props) {
  ...
  return /*#__PURE__*/React.createElement(ShippingAddressFormContext.Provider, {
    value: {
      validation: validation,
      setValue: setValue
    }
...
var SkuList = function SkuList(props) {
  ...
  var _useContext = useContext(SkuListsContext),
...
var SkuListsContainer = function SkuListsContainer(props) {
  ...
  var _useReducer = useReducer(skuListsReducer, skuListsInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(SkuListsContext.Provider, {
    value: state
  }, children);
};
...
var SkuOptionChildrenContext = /*#__PURE__*/createContext(initial$7);
...
var SkuOptionsContext = /*#__PURE__*/createContext(skuOptionsInitialState);
...
var SkuOption = function SkuOption(props) {
  ...
  var _useContext = useContext(SkuOptionsContext),
  ...
  var items = skuOptions && skuOptions.filter(function (l) {
    ...
    return /*#__PURE__*/React.createElement(SkuOptionChildrenContext.Provider, {
      key: k,
      value: {
        skuOption: skuOption,
        skuCode: skuCode
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, items);
};
...
var SkuOptionInput = function SkuOptionInput(props) {
  ...
  var _useContext2 = useContext(SkuOptionChildrenContext),
...
var SkuOptionsContainer = function SkuOptionsContainer(props) {
  ...
  var _useReducer = useReducer(skuOptionsReducer, skuOptionsInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(SkuOptionsContext.Provider, {
...
var VariantTemplate = function VariantTemplate(props) {
  ...
  var vars = _.keys(variants).map(function (v, k) {
    ...
    return type === 'select' ? /*#__PURE__*/React.createElement("option", {
      key: variants[v].id,
      "data-sku-id": variants[v].id,
      value: variants[v].code
    }, options.length > 0 ? options[k].label : variants[v].name) : /*#__PURE__*/React.createElement(Fragment, {
      key: variants[v].id
  ...
  if (type === 'select') {
    return /*#__PURE__*/React.createElement("select", _extends({
      ...
      value: skuCode || ''
    }, prs), /*#__PURE__*/React.createElement("option", {
      disabled: !!skuCode
    }, placeholder), vars);
  }

  return /*#__PURE__*/React.createElement(Fragment, null, vars);
};
...
var setSkuCode = function setSkuCode(params) {
  ...
  if (id) {
    CLayer.Sku.withCredentials(config).includes('skuOptions').find(id).then(function (s) {
      var _setItem;
...
var getVariants = function getVariants(params) {
  var config = params.config,
      ...
      setItem = params.setItem,
      filters = params.filters;
  CLayer.Sku.withCredentials(config).where(_extends({
...
var VariantsContext = /*#__PURE__*/createContext(variantInitialState);
...
var VariantSelector = function VariantSelector(props) {
  ...
  var _useContext = useContext(VariantsContext),
  ...
  var DefaultTemplate = function DefaultTemplate() {
    return loading ? /*#__PURE__*/React.createElement(Fragment, null, props.loader || 'Loading...') : /*#__PURE__*/React.createElement(VariantTemplate, _extends({
      variants: variants,
      type: type,
      placeholder: placeholder,
      skuCode: sCode,
  ...
  return children ? /*#__PURE__*/React.createElement(Parent, parentProps, children) : /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(DefaultTemplate, null));
};
...
var VariantsContainer = function VariantsContainer(props) {
  ...
  var _useReducer = useReducer(variantReducer, variantInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return Shipment$1.withCredentials(config).includes('availableShippingMethods', 'availableShippingMethods.deliveryLeadTimeForShipment', 'shipmentLineItems', 'shipmentLineItems.lineItem', 'stockTransfers', 'shippingMethod').find(shipmentId);

          case 5:
            shipment = _context2.sent;
            shippingMethod = ShippingMethod$1.build({
              id: shippingMethodId
            });
            _context2.next = 9;
...
var ShipmentContext = /*#__PURE__*/createContext(defaultShipmentContext);
...
var ShipmentsContainer = function ShipmentsContainer(props) {
  ...
  var _useReducer = useReducer(shipmentReducer, shipmentInitialState),
      state = _useReducer[0],
      dispatch = _useReducer[1];
  ...
  return /*#__PURE__*/React.createElement(ShipmentContext.Provider, {
    value: contextValue
  }, children);
};
...
var Shipment = function Shipment(_ref) {
  ...
  var _useContext = useContext(ShipmentContext),
  ...
  var components = shipments && shipments.map(function (shipment, k) {
    ...
    return /*#__PURE__*/React.createElement(ShipmentChildrenContext.Provider, {
      key: k,
      value: shipmentProps
    }, children);
  });
...
var ShippingMethodChildrenContext = /*#__PURE__*/createContext(initial$8);
...
var ShippingMethod = function ShippingMethod(props) {
  ...
  var _useContext = useContext(ShipmentChildrenContext),
  ...
  useEffect(function () {
    var methods = shippingMethods && shippingMethods.filter(function (s) {
      ...
      return /*#__PURE__*/React.createElement(ShippingMethodChildrenContext.Provider, {
        key: k,
        value: shippingProps
      }, children);
    });
...
var ShippingMethodName = function ShippingMethodName(props) {
  var _useContext = useContext(ShippingMethodChildrenContext),
      shippingMethod = _useContext.shippingMethod;
...
var ShippingMethodRadioButton = function ShippingMethodRadioButton(props) {
  ...
  var _useContext2 = useContext(ShipmentContext),
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("input", _extends({
    type: "radio",
    name: name,
...
var ShippingMethodPrice = function ShippingMethodPrice(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("span", p, priceCent === 0 ? labelFreeOver : price);
};
...
var StockTransferChildrenContext = /*#__PURE__*/createContext(initial$9);
...
var StockTransfer = function StockTransfer(props) {
  ...
  var components = stockTransfers == null ? void 0 : stockTransfers.filter(function (stock) {
    ...
    return /*#__PURE__*/React.createElement(StockTransferChildrenContext.Provider, {
      key: k,
...
var StockTransferField = function StockTransferField(props) {
  ...
  var _useContext = useContext(StockTransferChildrenContext),
...
var DeliveryLeadTime = function DeliveryLeadTime(props) {
  ...
  return props.children ? /*#__PURE__*/React.createElement(Parent, parentProps, props.children) : /*#__PURE__*/React.createElement("span", p, text);
};

DeliveryLeadTime.propTypes = propTypes$11;
DeliveryLeadTime.displayName = displayName$V;

export { AddToCartButton, Address, AddressCountrySelector, AddressField, AddressInput, AddressesContainer, AvailabilityContainer, AvailabilityTemplate, BillingAddressContainer, BillingAddressForm, CheckoutLink, CommerceLayer, CustomerContainer, CustomerInput, DeliveryLeadTime, DiscountAmount, Errors, ExternalFunction, GiftCard, GiftCardAmount, GiftCardContainer, GiftCardCurrencySelector, GiftCardInput, ItemContainer, LineItem, LineItemAmount, LineItemImage, LineItemName, LineItemOption, LineItemOptions, LineItemQuantity, LineItemRemoveLink, LineItemsContainer, LineItemsCount, MetadataInput, OrderContainer, OrderStorage, Price, PricesContainer, QuantitySelector, SaveAddressesButton, SaveCustomerButton, Shipment, ShipmentsContainer, ShippingAddressContainer, ShippingAddressForm, ShippingAmount, ShippingMethod, ShippingMethodName, ShippingMethodPrice, ShippingMethodRadioButton, SkuList, SkuListsContainer, SkuOption, SkuOptionInput, SkuOptionsContainer, StockTransfer, StockTransferField, SubTotalAmount, SubmitButton, TaxesAmount, TotalAmount, VariantSelector, VariantsContainer };
