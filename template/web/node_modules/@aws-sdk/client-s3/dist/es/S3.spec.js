...
describe("Accesspoint ARN", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        it("should succeed with outposts ARN", function () { return __awaiter(void 0, void 0, void 0, function () {
            var OutpostId, AccountId, region, credentials, client, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        expect(result.request.headers["authorization"]).contains("Credential=" + credentials.accessKeyId + "/20200928/" + region + "/s3-outposts/aws4_request");
                        return [2 /*return*/];
                }
            });
        }); });
