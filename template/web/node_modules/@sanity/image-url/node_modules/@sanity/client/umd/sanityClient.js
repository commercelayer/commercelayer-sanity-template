...
},{"./middleware/defaultOptionsProcessor":6,"./middleware/defaultOptionsValidator":7,"./request":14,"./util/middlewareReducer":16,"nano-pubsub":20}],6:[function(require,module,exports){
...
},{"object-assign":21,"url-parse":51}],7:[function(require,module,exports){
...
},{"is-plain-object":17,"object-assign":21}],9:[function(require,module,exports){
...
},{"object-assign":21}],10:[function(require,module,exports){
...
},{"../util/global":15,"object-assign":21}],11:[function(require,module,exports){
...
},{"parse-headers":22,"same-origin":49}],14:[function(require,module,exports){
...
},{"./config":29,"./symbol/observable":37,"./util/canReportError":41,"./util/pipe":47,"./util/toSubscriber":48}],26:[function(require,module,exports){
...
},{"./config":29,"./util/hostReportError":42}],27:[function(require,module,exports){
...
},{"../internal/symbol/rxSubscriber":38,"./Observer":26,"./Subscription":28,"./config":29,"./util/hostReportError":42,"./util/isFunction":45}],28:[function(require,module,exports){
...
},{"./util/UnsubscriptionError":40,"./util/isArray":44,"./util/isFunction":45,"./util/isObject":46}],29:[function(require,module,exports){
...
},{"../Observable":25}],31:[function(require,module,exports){
...
},{"../Subscriber":27}],32:[function(require,module,exports){
...
},{"../Subscriber":27}],33:[function(require,module,exports){
...
},{"../Subscriber":27}],34:[function(require,module,exports){
...
},{"../util/pipe":47,"./defaultIfEmpty":31,"./scan":35,"./takeLast":36}],35:[function(require,module,exports){
...
},{"../Subscriber":27}],36:[function(require,module,exports){
...
},{"../Subscriber":27,"../observable/empty":30,"../util/ArgumentOutOfRangeError":39}],37:[function(require,module,exports){
...
},{"../Subscriber":27}],42:[function(require,module,exports){
...
},{"./identity":43}],48:[function(require,module,exports){
...
},{"../Observer":26,"../Subscriber":27,"../symbol/rxSubscriber":38}],49:[function(require,module,exports){
...
},{"url":50}],50:[function(require,module,exports){
...
},{"querystringify":23,"requires-port":24}],52:[function(require,module,exports){
"use strict";function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_unsupportedIterableToArray(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function _iterableToArrayLimit(e,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e)){var r=[],n=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(n=(a=s.next()).done)&&(r.push(a.value),!t||r.length!==t);n=!0);}catch(e){i=!0,o=e}finally{try{n||null==s.return||s.return()}finally{if(i)throw o}}return r}}function _arrayWithHoles(e){if(Array.isArray(e))return e}var assign=require("object-assign"),_require=require("@sanity/observable/operators/map"),map=_require.map,_require2=require("@sanity/observable/operators/filter"),filter=_require2.filter,queryString=require("../http/queryString"),validators=require("../validators");function AssetsClient(e){this.client=e}function toDocument(e){var t=e.document;return Object.defineProperty(t,"document",{enumerable:!1,get:function(){return console.warn("The promise returned from client.asset.upload(...) now resolves with the asset document"),t}}),t}function optionsFromFile(e,t){return"undefined"!=typeof window&&t instanceof window.File?assign({filename:!1===e.preserveFilename?void 0:t.name,contentType:t.type},e):e}assign(AssetsClient.prototype,{upload:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};validators.validateAssetType(e);var n=r.extract||void 0;n&&!n.length&&(n=["none"]);var i=validators.hasDataset(this.client.clientConfig),o="image"===e?"images":"files",a=optionsFromFile(r,t),s=a.label,l=a.title,c=a.description,u=a.creditLine,d=a.filename,y=a.source,f={label:s,title:l,description:c,filename:d,meta:n,creditLine:u};y&&(f.sourceId=y.id,f.sourceName=y.name,f.sourceUrl=y.url);var p=this.client._requestObservable({method:"POST",timeout:a.timeout||0,uri:"/assets/".concat(o,"/").concat(i),headers:a.contentType?{"Content-Type":a.contentType}:{},query:f,body:t});return this.client.isPromiseAPI()?p.pipe(filter(function(e){return"response"===e.type}),map(function(e){return toDocument(e.body)})).toPromise():p},delete:function(e,t){console.warn("client.assets.delete() is deprecated, please use client.delete(<document-id>)");var r=t||"";return/^(image|file)-/.test(r)?e._id&&(r=e._id):r="".concat(e,"-").concat(r),validators.hasDataset(this.client.clientConfig),this.client.delete(r)},getImageUrl:function(e,t){var r=e._ref||e;if("string"!=typeof r)throw new Error("getImageUrl() needs either an object with a _ref, or a string with an asset document ID");if(!/^image-[A-Za-z0-9_]+-\d+x\d+-[a-z]{1,5}$/.test(r))throw new Error('Unsupported asset ID "'.concat(r,'". URL generation only works for auto-generated IDs.'));var n=_slicedToArray(r.split("-"),4),i=n[1],o=n[2],a=n[3];validators.hasDataset(this.client.clientConfig);var s=this.client.clientConfig,l=s.projectId,c=s.dataset,u=t?queryString(t):"";return"https://cdn.sanity.io/images/".concat(l,"/").concat(c,"/").concat(i,"-").concat(o,".").concat(a).concat(u)}}),module.exports=AssetsClient;

},{"../http/queryString":63,"../validators":73,"@sanity/observable/operators/filter":78,"@sanity/observable/operators/map":79,"object-assign":21}],53:[function(require,module,exports){
...
},{"object-assign":21}],54:[function(require,module,exports){
...
},{"./util/once":71,"./validators":73,"@sanity/generate-help-url":75,"object-assign":21}],55:[function(require,module,exports){
...
},{"../util/getSelection":70,"../validators":73,"./encodeQueryString":56,"./listen":57,"./patch":58,"./transaction":59,"@sanity/observable/operators/filter":78,"@sanity/observable/operators/map":79,"object-assign":21}],56:[function(require,module,exports){
...
},{"../util/getSelection":70,"../validators":73,"deep-assign":2,"object-assign":21}],59:[function(require,module,exports){
...
},{"../validators":73,"./patch":58,"object-assign":21}],60:[function(require,module,exports){
...
},{"../validators":73,"object-assign":21}],61:[function(require,module,exports){
...
},{"make-error":19,"object-assign":21}],63:[function(require,module,exports){
...
},{"./errors":62,"./nodeMiddleware":61,"@sanity/observable/minimal":77,"get-it":4,"get-it/lib/middleware/jsonRequest":8,"get-it/lib/middleware/jsonResponse":9,"get-it/lib/middleware/observable":10,"get-it/lib/middleware/progress":12,"object-assign":21}],65:[function(require,module,exports){
...
},{"object-assign":21}],66:[function(require,module,exports){
...
},{"object-assign":21}],67:[function(require,module,exports){
...
},{"object-assign":21}],69:[function(require,module,exports){
...
},{"@rexxars/eventsource-polyfill":1}],75:[function(require,module,exports){
...
},{"../operators/filter":78,"../operators/map":79,"../operators/reduce":80,"object-assign":21,"rxjs/internal/Observable":25}],77:[function(require,module,exports){
module.exports=require("./lib/SanityObservableMinimal");

},{"./lib/SanityObservableMinimal":76}],78:[function(require,module,exports){
exports.filter=require("rxjs/internal/operators/filter").filter;

},{"rxjs/internal/operators/filter":32}],79:[function(require,module,exports){
exports.map=require("rxjs/internal/operators/map").map;

},{"rxjs/internal/operators/map":33}],80:[function(require,module,exports){
exports.reduce=require("rxjs/internal/operators/reduce").reduce;

},{"rxjs/internal/operators/reduce":34}]},{},[67])(67)
});
