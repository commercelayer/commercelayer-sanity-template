...
exports.createSanityManifest = createSanityManifest;
...
function createPluginManifest(data, opts = {}) {
  const pkg = Object.assign(getCommonManifest(data), {
    main: 'src/plugin.js',
    scripts: {
...
function createSanityManifest(data, opts) {
  let manifest;
  ...
  if (opts.isPlugin) {
    ...
    manifest = {
      ...
      plugins: ['@sanity/base', '@sanity/components', '@sanity/default-layout', '@sanity/default-login', '@sanity/desk-tool'],
      env: {
        development: {
