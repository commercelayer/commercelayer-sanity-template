                ...
                switch (_c.label) {
                    ...
                    case 2:
                        try {
                            ...
                            module_1 = __spread(compilation_1.modules).find(function (searchModule) { return getModuleId(compilation_1, searchModule) === id; });
                            return [2 /*return*/, getModuleSource(compilation_1, module_1)];
                        }
                        catch (err) {
