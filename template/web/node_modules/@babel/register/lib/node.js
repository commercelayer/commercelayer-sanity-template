...
let compiling = false;
const internalModuleCache = _module.default._cache;

function compileHook(code, filename) {
  if (compiling) return code;
  const globalModuleCache = _module.default._cache;

  try {
    compiling = true;
    _module.default._cache = internalModuleCache;
    return compile(code, filename);
  } finally {
    compiling = false;
    _module.default._cache = globalModuleCache;
  }
}
